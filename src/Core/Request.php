...
class Request {
    ...
    public function getQueryParam(string $key, $default = null) { return isset($this->query[$key]) ? $this->query[$key] : $default; }
    public function getBodyParam(string $key, $default = null) { return isset($this->body[$key]) ? $this->body[$key] : $default; }
